...
export const ACTIVITY_LIBRARY: LifeActivityDefinition[] = [
  { id: 'cook', kind: 'meal', titleTemplates: ['做晚饭', '煮一碗面', '尝试一个新菜谱', '热了杯牛奶配吐司'], tags: ['cooking', 'home', 'food'], locationAffinity: ['home'], minDurationMinutes: 20, maxDurationMinutes: 60, allowedTimeRanges: [[7, 9], [11, 13], [17, 20]], baseWeight: 30, cooldownHours: 3, maxConsecutiveDays: 3, effects: { hunger: -45, energy: 8, comfort: 6 }, possibleOutcomes: ['cooked', 'slightly_failed'], followUpHooks: ['cleanup', 'read'], shareability: 0.5 },
  { id: 'eat', kind: 'meal', titleTemplates: ['吃午饭', '吃点东西垫垫肚子', '啃了个水果'], tags: ['food', 'home'], locationAffinity: ['home', 'cafe', 'restaurant'], minDurationMinutes: 15, maxDurationMinutes: 40, allowedTimeRanges: [[7, 22]], baseWeight: 20, cooldownHours: 2, maxConsecutiveDays: 5, effects: { hunger: -35, energy: 5 }, possibleOutcomes: ['normal'], followUpHooks: [], shareability: 0.15 },
  { id: 'nap', kind: 'rest', titleTemplates: ['午睡一会儿', '躺着闭目养神', '窝在沙发上打盹'], tags: ['rest', 'home'], locationAffinity: ['home'], minDurationMinutes: 20, maxDurationMinutes: 90, allowedTimeRanges: [[12, 16]], baseWeight: 18, cooldownHours: 4, maxConsecutiveDays: 3, effects: { energy: 14, stress: -6, focus: 4 }, possibleOutcomes: ['normal', 'overslept'], followUpHooks: ['wake'], shareability: 0.1 },
  { id: 'rest', kind: 'rest', titleTemplates: ['休息一下', '发一会儿呆', '躺着刷手机'], tags: ['rest', 'home', 'solo'], locationAffinity: ['home'], minDurationMinutes: 10, maxDurationMinutes: 40, baseWeight: 15, cooldownHours: 2, maxConsecutiveDays: 4, effects: { energy: 9, stress: -5 }, possibleOutcomes: ['normal'], followUpHooks: [], shareability: 0.1 },
  { id: 'reading', kind: 'play', titleTemplates: ['看小说', '继续读昨天那本书', '翻几页漫画'], tags: ['reading', 'home', 'solo'], locationAffinity: ['home', 'library', 'cafe'], minDurationMinutes: 20, maxDurationMinutes: 120, baseWeight: 22, cooldownHours: 2, maxConsecutiveDays: 4, effects: { curiosity: 6, comfort: 6, energy: -3 }, possibleOutcomes: ['normal', 'plot_twist', 'lost_track'], followUpHooks: ['share_quote'], shareability: 0.45 },
  { id: 'gaming', kind: 'play', titleTemplates: ['打游戏', '玩了一会儿游戏'], tags: ['gaming', 'home', 'solo'], locationAffinity: ['home'], minDurationMinutes: 30, maxDurationMinutes: 180, baseWeight: 20, cooldownHours: 2, maxConsecutiveDays: 5, effects: { stress: -8, curiosity: 4, energy: -4 }, possibleOutcomes: ['normal', 'frustrating', 'fun_session'], followUpHooks: [], shareability: 0.4 },
  { id: 'music', kind: 'play', titleTemplates: ['练琴', '弹了一会儿琴', '听歌发呆'], tags: ['music', 'home', 'solo'], locationAffinity: ['home'], minDurationMinutes: 20, maxDurationMinutes: 90, baseWeight: 20, cooldownHours: 3, maxConsecutiveDays: 3, effects: { comfort: 8, stress: -6, energy: -3 }, possibleOutcomes: ['progress', 'stuck'], followUpHooks: [], shareability: 0.5 },
  { id: 'craft', kind: 'play', titleTemplates: ['画画', '拼乐高', '做点小手工'], tags: ['craft', 'home', 'solo'], locationAffinity: ['home'], minDurationMinutes: 25, maxDurationMinutes: 120, baseWeight: 18, cooldownHours: 4, maxConsecutiveDays: 3, effects: { focus: 7, comfort: 6, energy: -4 }, possibleOutcomes: ['progress', 'normal'], followUpHooks: [], shareability: 0.5 },
  { id: 'walk', kind: 'out', titleTemplates: ['出门散步', '去公园走一圈', '沿街溜达'], tags: ['walk', 'outdoors'], locationAffinity: ['park', 'neighborhood', 'outdoor'], minDurationMinutes: 20, maxDurationMinutes: 80, allowedTimeRanges: [[8, 21]], baseWeight: 24, cooldownHours: 3, maxConsecutiveDays: 3, effects: { social_need: -8, loneliness: -10, curiosity: 8, energy: -6, stress: -4 }, possibleOutcomes: ['pleasant', 'normal', 'weather'], followUpHooks: ['shop', 'cafe'], shareability: 0.55 },
  { id: 'cafe', kind: 'out', titleTemplates: ['去咖啡店坐一会儿', '买杯拿铁看街景'], tags: ['cafe', 'out', 'drink', 'solo'], locationAffinity: ['cafe'], minDurationMinutes: 30, maxDurationMinutes: 120, allowedTimeRanges: [[9, 20]], baseWeight: 20, cooldownHours: 8, maxConsecutiveDays: 2, effects: { comfort: 7, social_need: -6, loneliness: -8, energy: 4 }, possibleOutcomes: ['normal', 'pleasant'], followUpHooks: ['reading'], shareability: 0.5 },
  { id: 'shopping', kind: 'out', titleTemplates: ['去超市买菜', '逛了趟超市', '顺路买点东西'], tags: ['shopping', 'out', 'errand'], locationAffinity: ['store', 'mall'], minDurationMinutes: 30, maxDurationMinutes: 90, allowedTimeRanges: [[9, 21]], baseWeight: 20, cooldownHours: 6, maxConsecutiveDays: 2, effects: { hunger: -8, comfort: 5, energy: -7 }, possibleOutcomes: ['normal', 'bought_snack'], followUpHooks: ['cook', 'organize'], shareability: 0.45 },
  { id: 'organize', kind: 'chore', titleTemplates: ['收拾房间', '整理书桌', '给房间换个布置'], tags: ['chore', 'home', 'organize'], locationAffinity: ['home'], minDurationMinutes: 20, maxDurationMinutes: 90, baseWeight: 20, cooldownHours: 5, maxConsecutiveDays: 2, effects: { comfort: 10, focus: 5, energy: -8 }, possibleOutcomes: ['normal', 'pleasant', 'found_thing'], followUpHooks: [], shareability: 0.5 },
  { id: 'laundry', kind: 'chore', titleTemplates: ['洗衣服', '晒被子', '叠衣服'], tags: ['chore', 'home'], locationAffinity: ['home'], minDurationMinutes: 15, maxDurationMinutes: 40, baseWeight: 16, cooldownHours: 8, maxConsecutiveDays: 2, effects: { comfort: 6, energy: -5 }, possibleOutcomes: ['normal'], followUpHooks: [], shareability: 0.2 },
  { id: 'cleaning', kind: 'chore', titleTemplates: ['打扫卫生', '拖地', '擦桌子'], tags: ['chore', 'home', 'cleaning'], locationAffinity: ['home'], minDurationMinutes: 15, maxDurationMinutes: 60, baseWeight: 15, cooldownHours: 6, maxConsecutiveDays: 2, effects: { comfort: 9, energy: -7 }, possibleOutcomes: ['normal'], followUpHooks: [], shareability: 0.2 },
  { id: 'shower', kind: 'wind_down', titleTemplates: ['洗个澡', '敷面膜', '洗漱'], tags: ['selfcare', 'home'], locationAffinity: ['home'], minDurationMinutes: 10, maxDurationMinutes: 30, allowedTimeRanges: [[7, 24]], baseWeight: 22, cooldownHours: 6, maxConsecutiveDays: 3, effects: { comfort: 10, stress: -5, energy: 3 }, possibleOutcomes: ['normal', 'pleasant'], followUpHooks: [], shareability: 0.1 },
  { id: 'garden', kind: 'play', titleTemplates: ['给花浇水', '看看花盆新长的芽', '打理阳台的绿植'], tags: ['garden', 'home'], locationAffinity: ['home'], minDurationMinutes: 10, maxDurationMinutes: 40, baseWeight: 12, cooldownHours: 6, maxConsecutiveDays: 3, effects: { comfort: 6, curiosity: 3 }, possibleOutcomes: ['normal', 'new_sprout'], followUpHooks: [], shareability: 0.55 },
  { id: 'study', kind: 'study', titleTemplates: ['学了一会儿东西', '看教程', '练习'], tags: ['study', 'home', 'solo'], locationAffinity: ['home', 'library', 'study', 'cafe'], minDurationMinutes: 20, maxDurationMinutes: 90, baseWeight: 18, cooldownHours: 4, maxConsecutiveDays: 3, effects: { focus: 9, curiosity: 5, energy: -8, stress: 3 }, possibleOutcomes: ['progress', 'stuck', 'normal'], followUpHooks: ['practice'], shareability: 0.35 },
  { id: 'work', kind: 'work', titleTemplates: ['处理积压的事情', '写东西', '整理资料'], tags: ['work', 'home', 'solo'], locationAffinity: ['home', 'work'], minDurationMinutes: 30, maxDurationMinutes: 150, baseWeight: 16, cooldownHours: 4, maxConsecutiveDays: 2, effects: { focus: 7, stress: 4, energy: -10 }, possibleOutcomes: ['progress', 'normal'], followUpHooks: [], shareability: 0.3 }
];
