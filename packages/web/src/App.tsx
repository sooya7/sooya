...
function ChatApp() {
  ...
  return <div className="app">
    ...
    <Composer key="chat-composer" disabled={chat.connection === 'connecting' && !chat.ready} stickers={chat.stickers} onSend={async (payload) => { const result = await chat.send(payload.content, payload.optimisticParts, quote?.id); setQuote(null); return result; }} onNotice={setNotice} />
  </div>;
}
