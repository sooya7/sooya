...
// outcomes; v45 provider_health; v46 auth_tokens; v47 flow_traces; v48 video_tasks.
// Purely additive — no existing table changes, no in-flight reply state — so
// older code simply never reads them.
const MAX_SCHEMA_VERSION = 48;
